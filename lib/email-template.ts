...
export const DEFAULT_EMAIL_COLORS: EmailBrandingColors = {
  ...
  linkColor: '#6b4f3a',
  buttonBackground: '#6b4f3a',
  buttonTextColor: '#fffaf2',
...
export const renderBrandEmail = (input: RenderBrandEmailInput) => {
  ...
  const ctaBlock = input.cta
    ? `<table role="presentation" cellspacing="0" cellpadding="0" style="margin:26px auto 0;"><tr><td style="border-radius:999px;background:linear-gradient(135deg,${colors.buttonBackground} 0%,${colors.titleColor} 100%);border:2px solid ${colors.titleColor};box-shadow:0 10px 24px -16px rgba(30,24,20,.65);">
